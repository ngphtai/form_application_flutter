...
class _TimePickerCustomState extends State<TimePickerCustom> {
  ...
  void updateTime() {
    ...
    context.read<TimePickerCustomBloc>().validate(formattedTime);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => widget.timePickerCustomBloc,
      child:
          BlocBuilder<TimePickerCustomBloc, bool>(builder: (context, isValid) {
            ...
            GestureDetector(
              onTap: () {
                setState(() {
                  ...
                  if (formattedTime == "")
                    context.read<TimePickerCustomBloc>().validate("false");
                });
              },
              child: Container(
                  width: size.width,
